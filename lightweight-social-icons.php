...
class lsi_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'lsi_Widget', // Base ID
			__('Lightweight Social Icons', 'lightweight-social-icons'), // Name
			array(
				'description' => __( 'Add social icons to your website.', 'lightweight-social-icons' ), 
			),
			array(
				'width' => 550,
			)
...
function lsi_icons( $options = '' ) {
	$options = array (
		...
		'amazon' => array(
			'id' => 'amazon',
			'name' => __( 'Amazon', 'lightweight-social-icons' )
		),
		'angellist' => array(
			'id' => 'angellist',
		...
		'bookbub' => array(
			'id' => 'bookbub',
			'name' => __( 'BookBub', 'lightweight-social-icons' )
		),
		'codepen' => array(
			'id' => 'codepen',
		...
		'goodreads' => array(
			'id' => 'goodreads',
			'name' => __( 'Goodreads', 'lightweight-social-icons' )
		),
		'gplus' => array(
			'id' => 'gplus',
